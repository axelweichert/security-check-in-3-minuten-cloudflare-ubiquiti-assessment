...
import { Globe, Sun, Moon, Shield, Wifi, Layers } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        <div className="flex items-center space-x-2 md:space-x-4 text-sm md:text-base">
          <a
            ...
            className="group transition-colors duration-200 hover:text-primary/90 flex items-center gap-1.5"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group transition-colors duration-200 hover:text-foreground flex items-center gap-1.5"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="hidden sm:flex items-center gap-1.5 group transition-colors duration-200 hover:text-foreground"
          >
